...
(function(global){
  ...
  var TOOLS = [
    ...
    {type:'function',function:{name:'store_in_book',description:'Append passage to book',parameters:{type:'object',properties:{book_name:{type:'string'},section:{type:'string'},passage:{type:'string'},title:{type:'string'}},required:['passage']}}},
    ...
    {type:'function',function:{name:'edit_book_passage',description:'Edit book passage',parameters:{type:'object',properties:{turn_id:{type:'integer'},book_name:{type:'string'},position:{type:'string'},title:{type:'string'},section:{type:'string'},passage:{type:'string'}},required:[]}}},
